...
df = [dict(Task="Nelson", Start='2020-01-01 10:00', Finish='2020-02-02 03:00', Resource='009372'),
...
for p in wl['workload']:
    df3 = dict(Task=p['employee'], Start=p['start'],
            Finish=p['end'], Resource=p['number'])
    df.append(df3)
